      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide">Thumbnail / Cover Image</label>

              {/* Upload zone */}
              <label className={`flex flex-col items-center justify-center gap-1.5 w-full py-4 rounded-xl border-2 border-dashed cursor-pointer transition-colors ${uploadingCover ? "border-amber-400 bg-amber-50 dark:bg-amber-900/10 pointer-events-none" : "border-gray-300 dark:border-gray-600 hover:border-amber-500 hover:bg-amber-50/50 dark:hover:bg-amber-900/10"}`}>
                ...
                {uploadingCover ? (
                  <><div className="w-5 h-5 border-2 border-amber-600 border-t-transparent rounded-full animate-spin" /><span className="text-xs text-amber-600 font-medium">Uploading…</span></>
                ) : (
                  <>
              ...
              {/* Preview with remove */}
              {form.cover_image && (
                <div className="relative mt-3 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 group bg-gray-100 dark:bg-gray-800">
                  <img src={form.cover_image} alt="Cover preview" className="w-full h-44 object-cover" onError={e => (e.currentTarget.style.display = "none")} />
                  ...
                  <div className="absolute bottom-2 left-2 text-[10px] bg-black/60 text-white px-2 py-0.5 rounded-md">Cover preview</div>
                </div>
              )}
            </div>
            <div>
