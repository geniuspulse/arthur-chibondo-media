...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://gbxescpzeogckclpsewb.supabase.co/storage/v1/object/public/article-images/1787293400-author-og.jpg', width: 1200, height: 630, alt: 'Arthur Chibondo' }],
  },
  twitter: {
