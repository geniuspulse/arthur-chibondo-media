...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://gbxescpzeogckclpsewb.supabase.co/storage/v1/object/public/article-images/1787419240-arthur-photo-og.jpg', width: 1200, height: 630, alt: 'Arthur Chibondo' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'APM Chibondo',
    description: 'Entrepreneur, Medical Student & Digital Creator from Malawi.',
    images: ['https://gbxescpzeogckclpsewb.supabase.co/storage/v1/object/public/article-images/1787419240-arthur-photo-og.jpg'],
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = {
    ...
    "url": "https://apmchibondo.blog",
    "image": "https://gbxescpzeogckclpsewb.supabase.co/storage/v1/object/public/article-images/1787419240-arthur-photo-og.jpg",
