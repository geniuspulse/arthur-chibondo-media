  ...
  return (
    <main>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <Link href="/projects" className="inline-flex items-center gap-2 text-sm text-green-600 mb-10"><ArrowLeft size={16} /> Back to Projects</Link>
        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-10">
          ...
          <div className="p-6 rounded-2xl bg-green-50 dark:bg-green-950/20 border border-green-100 dark:border-green-900/30">
            <h3 className="font-bold text-green-700 dark:text-green-400 mb-2">The Solution</h3>
