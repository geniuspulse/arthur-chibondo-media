  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/projects/new" className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors">
          ...
          {projects.map(p => (
            <div key={p.id} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all">
              ...
              <div className="p-4">
                ...
                <p className="text-xs text-green-600 mb-3">{p.tagline}</p>
                <div className="flex items-center gap-2">
                  ...
                  <Link href={`/admin/projects/${p.id}`} className="p-1.5 rounded-lg text-gray-400 hover:text-green-600 hover:bg-green-50 transition-colors">
                    <Edit size={14} />
                  </Link>
                  {p.website_url && (
